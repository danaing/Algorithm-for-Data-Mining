...
classification <- function() {
  ...
  cat("Enter 1 for LDA, 2 for QDA, 3 for RDA, 4 for Logistic Regression, 5 for Naive Bayes, 6 for 1-level decision tree, 7 for Bagging Ensemble.")
...
1/4,1/4,1/4,1/4
3
HW10KimDA_Ensemble(LDA)_R_output
